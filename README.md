...
5. **Get estimations for a given period**
   ...
   You can also call the [API deployed on Render](https://fgindexestimator.onrender.com/) from Python using the `requests` library. See the example in [deploy/README.md](deploy/README.md#api-call).
